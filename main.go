...
import (
	...
	"github.com/vasanthadevi/golang-angular/handlers"
...
func setAuth0Variables() {
	audience = os.Getenv("http://my-golang-api")
	domain = os.Getenv("dev-8yf955w8.us.auth0.com")
}
...
func authRequired() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var auth0Domain = "https://my-golang-api"
